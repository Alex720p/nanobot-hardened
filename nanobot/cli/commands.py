...
def gateway(
    ...
    agent = AgentLoop(
        ...
        web_search_config=config.sandbox.web.search,
        web_sandbox_config=config.sandbox.web.sandbox,
        workspace_sandbox_config=config.sandbox.workspace,
        web_proxy=config.sandbox.web.proxy or None,
        exec_config=config.sandbox.exec,
        cron_service=cron,
        restrict_to_workspace=config.sandbox.restrict_to_workspace,
        session_manager=session_manager,
        mcp_servers=config.sandbox.mcp_servers,
